...
export class orient3dView extends HTMLBoxView {
  model: orient3d
...
export interface orient3d extends orient3d.Attrs {}

export class orient3d extends HTMLBox {
  properties: orient3d.Props

  constructor(attrs?: Partial<orient3d.Attrs>) {
    super(attrs)
  }
  ...
  static initClass(): void {
    ...
    this.prototype.type = "orient3d"

    // This is usually boilerplate. In some cases there may not be a view.
    this.prototype.default_view = orient3dView
